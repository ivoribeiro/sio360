<template>
    <div class="content">
        <div class="md-layout">
            <div v-for="account in accounts" class="md-layout-item md-medium-size-100 md-size-33">
                <company-card :label="account.GroupingCategory"
                              icon="attach_money"
...
export default {
  ...
  mounted () {
    axios.get(process.env.VUE_APP_API_URL + '/company/accounts').then(response => {
